...
# Delete all README.md files generated by TypeDoc
echo "Deleting all auto-generated README.md files..."
find $DOCS_DIR -type f -name "README.md" -not -path "$BACKUP_DIR/*" -delete
